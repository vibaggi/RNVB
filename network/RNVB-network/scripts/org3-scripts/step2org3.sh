...
set -x
peer channel fetch 0 $CHANNEL_NAME.block -o orderer.rnvb.com:7050 --ordererTLSHostnameOverride orderer.rnvb.com -c $CHANNEL_NAME --tls --cafile $ORDERER_CA >&log.txt
res=$?
set +x
cat log.txt
